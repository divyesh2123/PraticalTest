                ...
                <Form>
                    <div className="card m-3">
                        <h5 className="card-header">
                            React + Formik Dynamic Form Example</h5>
                                ...
                                <div key={i} className="list-group list-group-flush">
                                    <div className="list-group-item">
                                        ...
                                        <div className="form-row">
                                            ...
                                            <div className="form-group col-6">
                                                <label>Email</label>
                                                <Field name={`mytickets.${i}.email`} type="text" className={'form-control' + (ticketErrors.email && ticketTouched.email ? ' is-invalid' : '' )} />
                                                <ErrorMessage name={`mytickets.${i}.email`} component="div" className="invalid-feedback" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
